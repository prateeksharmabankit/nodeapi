...
var Service = /** @class */ (function () {
    ...
    Service.prototype.listContainersSegmentNext = function (nextPageLink, options, callback) {
        return this.client.sendOperationRequest({
            nextPageLink: nextPageLink,
            options: options
        }, listContainersSegmentNextOperationSpec, callback);
    };
    return Service;
}());
export { Service };
...
var listContainersSegmentNextOperationSpec = {
    httpMethod: "GET",
    baseUrl: "{url}",
    path: "{nextLink}",
    urlParameters: [
